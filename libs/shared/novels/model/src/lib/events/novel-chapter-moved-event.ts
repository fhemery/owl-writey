...
export interface NovelChapterMovedData {
  id: string;
  atIndex: number;
}

export class NovelChapterMovedEvent extends NovelBaseDomainEvent<NovelChapterMovedData> {
