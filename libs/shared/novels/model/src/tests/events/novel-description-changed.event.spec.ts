...
describe('NovelDescriptionChangedEvent', () => {
  describe('static From', () => {
    it('should create a new event', () => {
      const event = NovelDescriptionChangedEvent.From({ description: 'new' });
    ...
    it('should fail if there is no description', () => {
      expect(() => NovelDescriptionChangedEvent.From('ab')).toThrowError(
        NovelException
      );
    });
  });
  ...
  it('should apply to a novel', () => {
    ...
    const event = new NovelDescriptionChangedEvent('new');
